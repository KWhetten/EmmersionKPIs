...
namespace KPIDataExtractor.UnitTests.Deserializer
{
    ...
    public class KanbanizeDeserializerTests
    {
        ...
        public void When_deserializing_work_item_card_list()
        {
            ...
            mockKanbanizeApiWrapper.Setup(x => x.GetWorkItemCardHistory(It.IsAny<JToken>(), It.IsAny<int>())).Returns(historyArray);
        ...
        public void When_work_item_card_is_created_in_active_column()
        {
            ...
            mockKanbanizeApiWrapper.Setup(x => x.GetWorkItemCardHistory(It.IsAny<JToken>(), It.IsAny<int>())).Returns("");
            var mockDataAccess = new Mock<IDataAccess>();
            mockDataAccess.Setup(x => x.GetReleasesBeforeDate(It.IsAny<DateTime>())).Returns(new List<Release>
            {
                new Release
