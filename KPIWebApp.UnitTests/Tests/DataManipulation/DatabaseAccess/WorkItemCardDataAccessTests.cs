...
{
    [TestFixture]
    public class WorkItemCardDataAccessTests
    {
        [Test]
        public void When_inserting_work_item_card_list()
        {
            ...
            accessWorkItemCardData.InsertWorkItemCardList(workItemCardList);

            var result1 = accessWorkItemCardData.GetCardById(card1.Id);

            var ex = Assert.Throws<InvalidOperationException>(() => accessWorkItemCardData.GetCardById(card2.Id));
            ...
            accessWorkItemCardData.RemoveWorkItemCardById(card1.Id);
        ...
        public void When_getting_work_item_cards_in_date_range()
        {
            ...
            var result = accessWorkItemCardData.GetWorkItemCardList(DateTime.Now.AddDays(-7), DateTime.Now);
