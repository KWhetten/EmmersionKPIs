...
namespace KPIDataExtractor.UnitTests.Tests.KPIWebApp
{
    public class BoxGraphHelperTests
    {
        ...
        public async Task When_getting_lead_time_box_graph_data()
        {
            ...
            {
                StartTime = new DateTime(2020, 10, 15, 5, 30, 0),
                FinishTime = new DateTime(2020, 10, 16, 5, 30, 0),
                Type = TaskItemType.Product
            };
            var productTaskItem2 = new TaskItem
            {
                StartTime = new DateTime(2020, 10, 14, 5, 30, 0),
                FinishTime = new DateTime(2020, 10, 16, 5, 30, 0),
                Type = TaskItemType.Product
            };
            var productTaskItem3 = new TaskItem
            {
                StartTime = new DateTime(2020, 10, 13, 5, 30, 0),
                FinishTime = new DateTime(2020, 10, 16, 5, 30, 0),
                Type = TaskItemType.Product
            };
            var productTaskItem4 = new TaskItem
            {
                StartTime = new DateTime(2020, 10, 12, 5, 30, 0),
                FinishTime = new DateTime(2020, 10, 16, 5, 30, 0),
                Type = TaskItemType.Product
            };
            var productTaskItem5 = new TaskItem
            {
                StartTime = new DateTime(2020, 10, 9, 5, 30, 0),
                FinishTime = new DateTime(2020, 10, 16, 5, 30, 0),
                Type = TaskItemType.Product
            };
            ...
            {
                StartTime = new DateTime(2020, 10, 1, 5, 30, 0),
                FinishTime = new DateTime(2020, 10, 16, 5, 30, 0),
                Type = TaskItemType.Unanticipated
            };
           ...
           var result = await  boxGraphHelper.GetLeadTimeBoxGraphData(DateTime.Today.AddDays(-7), DateTime.Today);
            ...
            Assert.That(result.Entries.ElementAt(0).TaskItemType, Is.EqualTo(TaskItemType.Product));
            ...
            Assert.That(result.Entries.ElementAt(1).TaskItemType, Is.EqualTo(TaskItemType.Engineering));
            ...
            Assert.That(result.Entries.ElementAt(2).TaskItemType, Is.EqualTo(TaskItemType.Unanticipated));
